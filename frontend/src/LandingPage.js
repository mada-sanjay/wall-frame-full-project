...
function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: "Segoe UI, Arial, sans-serif", background: "#fafafd", minHeight: "100vh" }}>
      {/* Hero Section */}
      <section style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "70vh", padding: "48px 0 32px 0" }}>
        <div style={{ background: "#fff", color: "#7c3aed", fontWeight: 600, fontSize: 18, borderRadius: 24, boxShadow: "0 2px 16px #ede9fe", padding: "10px 32px", marginBottom: 32, display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={{ fontSize: 22 }}>✨</span> Professional Wall Design Platform
        </div>
        <h1 style={{ fontSize: 64, fontWeight: 900, color: "#232946", margin: 0, textAlign: 'center', letterSpacing: 1 }}>Design Your<br /><span style={{ color: "#a78bfa" }}>Perfect Wall</span></h1>
        <div style={{ fontSize: 22, color: "#6b7280", margin: "32px 0 40px 0", textAlign: 'center', maxWidth: 700 }}>
        ...
        <div style={{ display: 'flex', gap: 18, marginBottom: 32 }}>
          ...
          <button onClick={() => window.scrollTo({ top: 900, behavior: 'smooth' })}
            style={{ background: "#fff", color: "#232946", fontWeight: 700, fontSize: 20, border: 'none', borderRadius: 12, padding: "16px 38px", cursor: "pointer", display: 'flex', alignItems: 'center', gap: 10, boxShadow: '0 2px 8px #ede9fe', border: '1.5px solid #ececec' }}>
      ...
      {/* Feature Highlights */}
      <section style={{ background: '#fafafd', padding: '32px 0 0 0' }}>
        <h2 style={{ textAlign: 'center', fontSize: 38, fontWeight: 800, color: '#232946', marginBottom: 8 }}>Comprehensive Feature Set</h2>
        <div style={{ textAlign: 'center', color: '#6b7280', fontSize: 20, marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 32, marginBottom: 48 }}>
          ...
          {[
            ...
            <div key={idx} style={{ background: '#fff', borderRadius: 18, boxShadow: '0 2px 12px #ede9fe', padding: 32, minWidth: 280, maxWidth: 340, flex: 1, margin: 8 }}>
              <div style={{ fontSize: 38, marginBottom: 12 }}>{f.icon}</div>
              <h3 style={{ fontWeight: 800, fontSize: 22, marginBottom: 8 }}>{f.title}</h3>
              <div style={{ color: '#6b7280', fontSize: 16, marginBottom: 12 }}>{f.desc}</div>
      ...
      <section style={{ background: '#fafafd', padding: '32px 0 0 0' }}>
        <h2 style={{ textAlign: 'center', fontSize: 38, fontWeight: 800, color: '#232946', marginBottom: 8 }}>How It Works</h2>
        <div style={{ textAlign: 'center', color: '#6b7280', fontSize: 20, marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 48, flexWrap: 'wrap', marginBottom: 48 }}>
          {[
            ...
            <div key={idx} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 180, maxWidth: 220 }}>
              ...
              <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 4 }}>{step.title}</div>
              <div style={{ color: '#6b7280', fontSize: 15 }}>{step.desc}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Pricing Section */}
      <section style={{ background: '#fafafd', padding: '32px 0 0 0' }}>
        <h2 style={{ textAlign: 'center', fontSize: 38, fontWeight: 800, color: '#232946', marginBottom: 8 }}>Choose Your Plan</h2>
        <div style={{ textAlign: 'center', color: '#6b7280', fontSize: 20, marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 32, flexWrap: 'wrap', marginBottom: 48 }}>
          ...
          {[
            ...
            <div key={idx} style={{ background: plan.color, borderRadius: 20, boxShadow: '0 4px 24px #ede9fe', padding: 36, minWidth: 260, maxWidth: 340, flex: 1, margin: 8, border: plan.popular ? '2.5px solid #a78bfa' : 'none', position: 'relative' }}>
              ...
              <h2 style={{ fontWeight: 800, fontSize: 28, marginBottom: 8, color: '#232946' }}>{plan.name}</h2>
              <div style={{ fontSize: 38, fontWeight: 900, color: plan.text, marginBottom: 4 }}>{plan.price}</div>
              <div style={{ color: '#6b7280', fontSize: 16, marginBottom: 8 }}>{plan.desc}</div>
